...
public class GuiProducto extends JDialog implements ActionListener {
	...
	protected void do_btnAgregar_actionPerformed(ActionEvent e) {
		try {
			Producto p=new Producto(LeerID(),LeerNombre(), LeerPrecio(),LeerCategoria(),LeerStock(), LeerStockMin());
			
			if (pS.BuscarId(LeerID())!=null) {
				JOptionPane.showMessageDialog(this,"El código del producto ya existe");
				return;
			}
			pS.addProducto(p);
			JOptionPane.showMessageDialog(this,"El product fue registrado con éxito.");
		} catch (Exception e2) {
